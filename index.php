...
<html lang="en">
    ...
    <body> 
        ...
        <section class="section-documents">
            <div class="row">
                <a id="section-documents"><h2 class="headline">What do you need to do?</h2></a>
                <p class="long-copy tagline">
                Hello we are Hire Lawyer. Our services help you with all your needs. From renting out properties to getting a divorce, we will be with you from court to bedside.
                </p>
                ...
                <form method="post" action="/app/assets/api/User/incorporation.php" class="contact-form">
                    <div class="row">
                        ...
                        <div class="col span-2-of-3">
                                <textarea rows="1" name="name" placeholder="Enter your name"></textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col span-1-of-3">
                        ...
                        <div class="col span-2-of-3">
                                <textarea rows="1" name="email" placeholder="Enter your email address"></textarea>
                        </div>    
                    </div>
                    <div class="row">  
                            <div class="col span-1-of-3">
                            ...
                            <div class="col span-2-of-3">
                                <select name="incorporation" id="incorporation">
                    ...
                    <div class="row">
                        ...
                        <div class="col span-2-of-3">
                            <!-- <a class="btn btn-full" href="#">Submit</a>  -->
        ...
        <section class="ask-lawyer">
            <div class="row">
                <a id="ask-lawyer"><h2>Ask a lawyer</h2></a>
                <p class="long-copy">
                Get quick answers from real lawyers, easily. Ask any legal question, or have an On Call attorney review your document.
                </p>    
            </div>
            <form method="post" action="./app/assets/api/User/asklawyer.php" class="contact-form">
                <div class="row">
                    <div class="col span-1-of-3">
                        <label>Drop us a line</label>
                    </div>
                    <div class="col span-2-of-3">
                            <textarea rows="10" name="question" placeholder="Enter your detailed legal question"></textarea>
                    </div>
                </div>
                <div class="row">
                    <div class="col span-1-of-3">
        ...
        <section class="section-plans">  
            <div class="row headline">
                <a id="section-plans"><h2>All the legal help you need. Anytime. Anywhere.</h2></a>
            </div>
            <div class="row tagline">
                <div class="col span-1-of-2">
                    <div class="plan-box">
                        <div class="price">
                            ...
                            <p class="plan-price">$39.99<span>/ year</span></p> 
                        </div>
                        <div>
                            <ul>
                                <li><i class="ion-checkmark"></i>Unlimited consultations</li>
                                <li><i class="ion-checkmark"></i>Available 24/7</li>
                                <li><i class="ion-checkmark"></i>Access to all documents</li>
                                <li><i class="ion-checkmark"></i>Free delivery</li>
                            </ul>
                        </div>
                        <div>
                            <a href="payment/index_2.php" class="btn btn-full">Buy now</a>
                        </div>
                    </div>
                </div>
                <div class="col span-1-of-2">
                    <div class="plan-box">
                        <div class="price">
                            <h3>Non-Premium</h3>
                            <p class="plan-price">$0<span>/ year</span></p> 
                        </div>
                        <div>
                            <ul>
                                <li><i class="ion-checkmark"></i>1 consulation/day</li>
                                <li><i class="ion-checkmark"></i>Daytime consultation only</li>
                                <li><i class="ion-close"></i>Access to all documents</li>
                                <li><i class="ion-checkmark"></i>Free delivery</li>
                            </ul>
                        </div>
                        <div>
            ...
            <div class="row">
                <div class="col span-1-of-2">
                    <ul class="footer-nav">
                        ...
                        <li><a href="#">Blog</a></li>
                        <li><a href="#">Press</a></li><li><a href="#">iOS App</a></li><li><a href="#">Android App</a></li>
                    </ul>
                </div>
                <div class="col span-1-of-2">
                    <ul class="social-links">
                        ...
                        <li><a href="#" class="ion-social-googleplus"></a></li><li><a href="#" class="ion-social-twitter"></a></li>
                    </ul>
                </div>
                <div class="row">
        ...
        <a class="gotop-btn" href="#"><i class="ion-arrow-up-c"></i></a>
